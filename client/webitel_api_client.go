...
import (
	...
	"github.com/kirychukyurii/webitel-openapi-client-go/transport"

	"github.com/kirychukyurii/webitel-openapi-client-go/client/access_store"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_absence_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_chats_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_pause_cause_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_skill_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_team_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/agent_working_conditions_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/audit_form_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/auth"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/backend_profile_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/bucket_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/calendar_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/call_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/catalog"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/chat_helper_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/classes"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/cognitive_profile_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/communication_type_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/config_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/contact_linking_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/contacts"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/contacts_chat_catalog"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/customers"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/devices"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/domains"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/email_profile_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/emails"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/file_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/file_transcript_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/forecast_calculation_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/i_m_clients"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/import_template_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/labels"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/ldap"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/list_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/logger_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/managers"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/media_file_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/member_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/o_auth2_federation"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/outbound_resource_group_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/outbound_resource_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/pause_template_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/permissions"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/phones"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/presence"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/preset_query_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/queue_bucket_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/queue_hook_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/queue_resources_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/queue_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/queue_skill_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/region_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/roles"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/routing_chat_plan_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/routing_outbound_call_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/routing_schema_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/routing_variable_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/schema_variables_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/schema_version_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/shift_template_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/skill_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/system_setting_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/team_hook_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/team_trigger_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/timeline"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/timezones"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/trigger_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/two_factor_authentication"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/user_access_tokens"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/user_helper_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/user_settings"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/users"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/variables"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/web_hook_service"
	"github.com/kirychukyurii/webitel-openapi-client-go/client/working_condition_service"
)
