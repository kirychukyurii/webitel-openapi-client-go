...
CreateWebHookParams contains all the parameters to send to the API endpoint
	...
	for the create web hook operation.
...
type CreateWebHookParams struct {
	...
	// Body.
	Body *models.EngineCreateWebHookRequest
...
// WithDefaults hydrates default values in the create web hook params (not the query body).
//
...
// SetDefaults hydrates default values in the create web hook params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the create web hook params
func (o *CreateWebHookParams) WithTimeout(timeout time.Duration) *CreateWebHookParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create web hook params
func (o *CreateWebHookParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create web hook params
func (o *CreateWebHookParams) WithContext(ctx context.Context) *CreateWebHookParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create web hook params
func (o *CreateWebHookParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create web hook params
func (o *CreateWebHookParams) WithHTTPClient(client *http.Client) *CreateWebHookParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the create web hook params
func (o *CreateWebHookParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the create web hook params
func (o *CreateWebHookParams) WithBody(body *models.EngineCreateWebHookRequest) *CreateWebHookParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create web hook params
func (o *CreateWebHookParams) SetBody(body *models.EngineCreateWebHookRequest) {
	o.Body = body
}
