...
type UpdateTriggerParams struct {
	...
	// Body.
	Body *models.EngineUpdateTriggerRequest
...
func (o *UpdateTriggerParams) WithBody(body *models.EngineUpdateTriggerRequest) *UpdateTriggerParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update trigger params
func (o *UpdateTriggerParams) SetBody(body *models.EngineUpdateTriggerRequest) {
	o.Body = body
}

// WithID adds the id to the update trigger params
func (o *UpdateTriggerParams) WithID(id int32) *UpdateTriggerParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update trigger params
func (o *UpdateTriggerParams) SetID(id int32) {
	o.ID = id
}
